"""
Django settings for carsello project.
...
SECRET_KEY = 'django-insecure-8(lx5cd4(%i4spqy_!$iin%7d*1%v@3$ths9reu6(ig=fup-8d'
...
WSGI_APPLICATION = 'carsello.wsgi.application'
